                ...
                <div class="container">
                    <div class="row">
                        <div class="col-sm-3 col-xs-12">
                            <!-- Header Logo -->
                            <div class="logo">
                                <a title="Magento Commerce" href="index.php"><img alt="Magento Commerce"
                ...
                <div class="col-main">
                                        ...
                                        <tfoot>
                                            <tr class="first last">
                                                <td class="a-right last" colspan="8">
                                                    ...
                                                    <button id="empty_cart_button" class="button" title="Clear Cart"
                    ...
                    <tr class="first odd">
                      ...
                      <h2 class="product-name">
                        <a href="product_detail.php">'.$rows['name'].'</a>
                      </h2>
                      </td>
                    ...
                    <div class="crosssel wow bounceInUp animated">
                        ...
                        <?php
                  $cart_colla=$p->sub_connect();
                  $sql4="SELECT * FROM products LIMIT 4";
                  $dir = 'products-images/';
                  $result = $cart_colla->query($sql4);
                  
                  if($result->num_rows>0){
                    while($rows=$result->fetch_assoc()){
                      echo '<div class="category-products">
                      <div class="products-grid crosssel-pro">
                        <div class="item col-lg-3 col-md-3 col-sm-4 col-xs-6">
                          <div class="item-inner">
                            <div class="item-img">
                              <div class="item-img-info">
                                <a
                                  href="product_detail.php?id='.$rows['pro_id'].'"
                                  title="Sample Product"
                                  class="product-image"
                                >
                                  <img
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-sm-3 col-xs-6">
                        <div class="col free-shipping">
                            <strong>Free Shipping</strong> on order over $199
                        </div>
                    </div>
                    <div class="col-lg-3 col-sm-3 col-xs-6">
                    ...
                    <div class="col-lg-3 col-sm-3 col-xs-6">
                        <div class="col last offer">
                            <strong>New Collection</strong> Lorem ipsum.
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-xs-12 col-lg-8">
                                <div class="footer-column pull-left collapsed-block">
                                    <h4>
                                        Shopping Guide<a class="expander visible-xs" href="#TabBlock-1">+</a>
                                    </h4>
                                ...
                                <div class="footer-column pull-left collapsed-block">
                                    <h4>
                                        Style Advisor<a class="expander visible-xs" href="#TabBlock-2">+</a>
                                    </h4>
                                    <div class="tabBlock" id="TabBlock-2">
                                        <ul class="links">
                                            <li class="first">
                                                <a title="Your Account" href="login.php">Your Account</a>
                                            </li>
                                            <li><a title="Information" href="#">Information</a></li>
                                            <li><a title="Addresses" href="#">Addresses</a></li>
                                            <li><a title="Addresses" href="#">Discount</a></li>
                                            <li>
                                                <a title="Orders History" href="#">Orders History</a>
                                            </li>
                                            <li class="last">
                                                <a title=" Additional Information" href="#">Additional Information</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                            ...
                            <div class="col-xs-12 col-lg-4">
                                <div class="footer-column-last">
                                    <div class="newsletter-wrap collapsed-block">
                                        <h4>
                                            Sign up for emails<a class="expander visible-xs" href="#TabBlock-4">+</a>
                                        </h4>
                ...
                <div class="footer-middle">
                    <div class="container">
                        <div class="row">
                            ...
                            <address>
                                <i class="icon-location-arrow"></i> 123 Main Street, Anytown,
                                CA 12345 USA <i class="icon-mobile-phone"></i><span> +(408) 394-7557</span> <i
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-sm-5 col-xs-12 coppyright">
                                &copy; 2015 Magikcommerce. All Rights Reserved.
                            </div>
                            <div class="col-sm-7 col-xs-12 company-links">
                                <ul class="links">
                                    <li>
                                        <a title="Magento Themes" href="#">Magento Themes</a>
                                    </li>
                                    <li>
                                        <a title="Premium Themes" href="#">Premium Themes</a>
                                    </li>
                                    <li>
                                        <a title="Responsive Themes" href="#">Responsive Themes</a>
                                    </li>
                                    <li class="last">
                                        <a title="Magento Extensions" href="#">Magento Extensions</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                ...
                <ul>
                    <li>
                        ...
                        <ul class="level1">
                            <li class="level2 nav-6-1-1">
                                <a href="grid.html">Sport Shoes</a>
                            </li>
                            <li class="level2 nav-6-1-1">
                                <a href="grid.html">Casual Shoes</a>
                            </li>
                            <li class="level2 nav-6-1-1">
                                <a href="grid.html">Leather Shoes</a>
                            </li>
                            <li class="level2 nav-6-1-1">
                                <a href="grid.html">canvas shoes</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                    ...
                    <li>
                        ...
                        <ul class="level1">
                            ...
                            <li class="level2 nav-6-1-1">
                                <a href="grid.html">Formal Jackets</a>
                            </li>
                            <li class="level2 nav-6-1-1">
                    ...
                    <li>
                        ...
                        <ul class="level1">
                            <li class="level2 nav-6-1-1">
                                <a href="grid.html">Backpacks</a>
                            </li>
                            <li class="level2 nav-6-1-1">
                                <a href="grid.html">Wallets</a>
                            </li>
                            <li class="level2 nav-6-1-1">
                                <a href="grid.html">Laptops Bags</a>
                            </li>
                ...
                <ul>
                    ...
                    <li>
                        ...
                        <ul>
                            ...
                            <li>
                                <a href="grid.html"><span>Camera Accesories</span></a>
                            </li>
                        </ul>
                    </li>
                    <li>
                    ...
                    <li>
                        ...
                        <ul>
                            <li>
                                <a href="grid.html"><span>External Hard Disk</span></a>
                            </li>
                            <li>
                    ...
                    <li>
                        ...
                        <ul>
                            <li>
                                <a href="grid.html"><span>Vaccum Cleaners</span></a>
                            </li>
                            <li>
                            ...
                            <li>
                                <a href="grid.html"><span>Water Purifier</span></a>
                            </li>
                        </ul>
                    </li>
                </ul>
