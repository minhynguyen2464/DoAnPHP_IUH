                        ...
                        <div class="col-lg-9 col-xs-12 right_menu">
                            <div class="toplinks">
                                ...
                                <div class="links">
									...
									<?php echo('account-info.php?userid='.$user_id.'')?>"><span
                                                class="hidden-xs">My
                                                Account</span></a></div>
                                    <div class="check"><a title="Checkout" href="<?php echo('shopping_cart.php?userid='.$user_id.'')?>"><span
                        ...
                        <article class="col-main">
                            ...
                            <div class="category-products">
                                <ul class="products-grid">
                                    <?php
                	$sql = "SELECT * FROM products where comp_id=1 and gender='female'";
					$p->men_nike_list($sql);
				?>
                                </ul>
                            </div>
