            ...
            <form role="form" method="post" enctype="multipart/form-data">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="txtPrice" name="txtPrice" placeholder="Nhập giá sản phẩm">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
					     <label for="textarea">Mô tả:</label>
           	    		<textarea name="textarea" cols="30" rows="5" id="textarea" style="width: 591px; height: 71px;"></textarea>
                </div>
                <div class="form-group">
		...
		<?php
        	if(isset($_REQUEST['submit'])){
				...
				$sql = "INSERT INTO products(name, price, image, description) 
						VALUES('$name', '$price', '$fileName', '$description')";
