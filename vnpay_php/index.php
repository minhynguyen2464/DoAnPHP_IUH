...
<body>
    ...
    <div class="container">
        ...
        <h3>Tạo mới đơn hàng (KHÔNG CẦN NHẬP)</h3>
            ...
            <form action="vnpay_create_payment.php" id="create_form" method="post">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" id="amount" name="amount" type="number"
                        value="<?php $p->return_order_detail($user_id,$date,'subtotal'); ?>" />
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <h3>Thông tin hóa đơn (Billing) (KHÔNG CẦN NHẬP)</h3>
                </div>
                <div class="form-group">
                    <label>Họ tên (*)</label>
                ...
                <div class="form-group">
                    <h3>Thông tin giao hàng (Shipping)(KHÔNG CẦN NHẬP)</h3>
                </div>
                <div class="form-group">
                    <label>Họ tên (*)</label>
                ...
                <div class="form-group">
                    <h3>Thông tin gửi Hóa đơn điện tử (Invoice) (KHÔNG CẦN NHẬP)</h3>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <label>User ID</label>
                    <input class="form-control" id="txt_user_id" name="txt_user_id" type="text"
                        value="<?php echo $user_id; ?>" />
                </div>
                <div class="form-group">
                    <label>Ngày đặt hàng</label>
                    <input class="form-control" id="txt_order_date" name="txt_order_date" type="text"
                        value="<?php echo $date; ?>" />
                </div>
