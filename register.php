      ...
      <div class="account-login">
        ...
        <fieldset class="col2-set">
          ...
          <div class="col-1 new-users"><strong>Khách hàng cũ</strong>
            <div class="content">
              <p>Nếu như bạn đã từng tạo tài khoản tại website của chúng tôi thì vui lòng ấn nút đăng nhập ở bên dưới</p>
              <div class="buttons-set">
             
                <button class="button create-account"><span><a href="login.php">ĐĂNG NHẬP</a></span></button>
              </div>
            </div>
          </div>
              ...
              <div class="content">
                ...
                <ul class="form-list">
                  <li>
                    ...
                    <br>
                    <input type="text" title="Username" class="input-text" id="txtUsername" value="" name="txtUsername">
                  </li>
                   
                   <li>
                    <label for="txtEmail">Email<span class="required">*</span></label>
                    <br>
                    <input type="email" title="Email" class="input-text" id="txtEmail" value="" name="txtEmail">
                  </li>
                   
                   <li>
                    <label for="txtPassword">Mật khẩu: <span class="required">*</span></label>
                    <br>
                    <input type="password" title="Password" class="input-text" id="txtPassword" value="" name="txtPassword">
                  </li>
					
                   <li>
                    <label for="txtPassword2">Nhập lại mật khẩu<span class="required">*</span></label>
                    <br>
                    <input type="password" title="Password" class="input-text" id="txtPassword2" value="" name="txtPassword2">
                  </li>
                 
                </ul>
                <p class="required">* Bắt buộc điền</p>
                <div class="buttons-set">
                  <button id="register" name="register" type="submit" class="button login"><span>Đăng ký</span></button>
                 </div>
              </div>
            </div>
          </form>
