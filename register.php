            ...
            <div class="main container">
                <div class="account-login">
                    ...
                    <fieldset class="col2-set">
                        ...
                        <div class="col-1 new-users"><strong>Khách hàng cũ</strong>
                            <div class="content">
                                <p>Nếu như bạn đã từng tạo tài khoản tại website của chúng tôi thì vui lòng ấn nút đăng
                                    nhập ở bên dưới</p>
                                <div class="buttons-set">

                                    <button class="button create-account"><span><a href="login.php">ĐĂNG
                                                NHẬP</a></span></button>
                                </div>
                            </div>
                        </div>
                        <form action="register.php" method="post" name="registerform" id="registerform">
                            <div class="col-2 registered-users"><strong>Đăng ký tài khoản</strong>
                                <div class="content">
                                    <p>Nếu như bạn chưa có tài khoản, vui lòng đăng ký tài đây</p>
                                    <ul class="form-list">
                                        <li>
                                            <label for="txtUsername">Tên đăng nhập<span
